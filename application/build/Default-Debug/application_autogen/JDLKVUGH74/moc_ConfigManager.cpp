...
#include <memory>
#include "../../../../library/ConfigManager.h"
...
QT_MOC_LITERAL(1, 14, 13), // "messageSignal"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 7) // "message"

    },
    "ConfigManager\0messageSignal\0\0message"
};
...
void ConfigManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConfigManager::messageSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ConfigManager::messageSignal(const QString & _t1)
{
